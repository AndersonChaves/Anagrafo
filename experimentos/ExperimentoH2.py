...
das arestas sugeridas por he, hp e fb (k=2)."""

class ExperimentoH2(Experimento):
    def __init__(self):
        ...
        self.tabela_de_resultados = Tabela(lista_de_parametros,
                                           "ExperimentoH.1 - Grau Maximo=4 (3005)")

    def gerar_grafos_a_serem_analisados(self):
        lista_de_grafos = []
        for grau_maximo in [5]:
            ordem_maxima = grau_maximo * 8 + 1
...
#ExperimentoH2().executar_experimento()